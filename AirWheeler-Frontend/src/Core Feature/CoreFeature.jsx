  ...
  return (
    <section className="md:w-full  bg-[#fafafa]   py-10 flex flex-col items-center overflow-x-hidden ">
      ...
      <div className="max-w-[1340px] bg-cyan-500 rounded-xl w-full flex flex-col md:flex-row items-center justify-center my-5 px-2">
        ...
        <div className="w-full md:w-1/2 flex flex-col items-center md:items-start p-3 ">
          <h3 className="text-2xl font-semibold text-gray-200 mb-2 text-center md:text-left">
            Smart Travel. Effortless Style.{" "}
            <span className="text-white font-bold">Ultimate Convenience. </span>
          </h3>
          <p className="text-gray-200 mb-2 text-center md:text-left">
            Turn every trip into an adventure with Air Wheel smart luggage. Ride
            through terminals, commute hands-free, and carry your essentials in
            one sleek, motorized suitcase. Engineered for modern travelers who
            demand speed, comfort, and innovation—all in one.
          </p>
          <br />
          <span className="hidden md:block">
            <p className="text-gray-200 text-sm font-semibold mb-1 text-center md:text-left">
              Redefining the Way You Travel
            </p>
            <br />
            <p className="text-gray-200 text-sm text-center md:text-left">
              Imagine you’re rushing through a crowded airport, your gate is at
              the other end of the terminal, and your hands are full with your
              phone and coffee. Instead of dragging a heavy suitcase behind you,
              you hop onto your{" "}
              <b className="text-white">Liberty Air spaWheel</b> smart luggage.
              With the touch of a button, the powerful motor kicks in, gliding
              you smoothly across the terminal floor. The wide, stable wheels
              handle every turn with ease, and the smart speed control lets you
              adjust your pace as you weave through people. You’re riding
              comfortably, with your essentials safely packed inside the
              durable, stylish case. Even after a long day of travel, the
              battery still has power to take you from the terminal to the taxi
              stand outside. And when you need to stop, the responsive brakes
              ensure you can slow down safely. Liberty Air Wheel offers you more
              than just luggage—it’s your travel companion, built for speed,
              safety, and effortless convenience..
            </p>
          </span>
        </div>
      </div>
      ...
      <div className="max-w-[1340px] w-full my-5  flex flex-col md:flex-row-reverse items-center justify-center mb-8 px-2">
        ...
        <div className="w-full  md:w-1/2 flex flex-col items-center md:items-start px-3">
          ...
          <p className="text-gray-500 mb-2 text-center md:text-left">
            The Airwheel features a smart handle system that lets you
            accelerate, brake, and reverse effortlessly.{" "}
            <span className="hidden md:block">
              Imagine rolling your suitcase at the airport: push the handle
              forward to move, pull it back to stop, and press both handles to
              reverse. With a top speed of 13 km/h, removable batteries, and an
              app to track settings, Airwheel simplifies your travels. It’s
              award-winning and perfect for busy travelers seeking convenience
              and style!
            </span>
          </p>
      ...
      <div className="max-w-[1340px] p-10 bg-cyan-500 rounded-xl w-full flex flex-col md:flex-row items-center justify-center my-5  px-2">
        ...
        <div className="w-full md:w-1/2 flex flex-col items-center md:items-start p-3">
          <h3 className="text-2xl font-semibold text-gray-200 mb-2 text-center md:text-left">
            Zip Through the City with E-Scooter{" "}
            <span className="font-bold">Liberty Air Wheel</span>
          </h3>
          <p className="text-gray-200 mb-2 text-center md:text-left">
            Effortless, eco-friendly, and built for the fast-moving urban
            lifestyle. The Liberty Air Wheel E-Scooter delivers smooth
            acceleration, smart controls, and a durable frame designed for daily
            commutes. Whether you're heading to work, exploring the city, or
            just enjoying the ride, this scooter combines speed, safety, and
            style in one sleek package.
          </p>
          <br />

          <span className="hidden md:block">
            <p className="text-gray-200 text-sm font-bold mb-1 text-center md:text-left">
              Your Commute, Reimagined
            </p>
            <p className="text-gray-200 text-sm text-center md:text-left">
              Cut through traffic and cruise the streets with the Liberty Air
              Wheel E-Scooter. Lightweight yet powerful, this smart scooter
              offers a smooth, silent ride with responsive brakes and
              long-lasting battery life. Perfect for city explorers and daily
              commuters who want to travel smarter, faster, and greener—without
              breaking a sweat.
            </p>
          </span>
        </div>
        <div className="w-full md:w-1/2  rounded-xl  flex justify-center mb-8 md:mb-0">
          <img
            src={
              scooter ||
              `https://purepng.com/public/uploads/thumbnail//lime-e-scooter-niy.png`
            }
            alt="SRM Rotor 3D Power Meter"
