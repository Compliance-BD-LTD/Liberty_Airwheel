...
export const BlogCard = ({ post }) => {
        ...
        if (post) {
            ...
            Swal.fire({
                ...
                if (result.isConfirmed) {
                    ...
                    axios.delete(`${import.meta.env.VITE_BACKEND_URL}/api/deleteBlog`, { data: { id: post._id } })
                        .then((res) => {
    ...
    return (
        <div className=" relative group  "  data-aos="fade-up"   data-aos-duration="1500"> 
            <div className="bg-white rounded-lg shadow-2xl overflow-hidden flex flex-col h-full">
                <div className="relative">
                    ...
                    />
                    <span className="absolute bottom-3 right-3 bg-cyan-500 text-white px-4 py-1 rounded font-semibold text-xs">
                        {post?.date}
                    </span>
                </div>
                <div className="p-5 flex flex-col flex-1">
                    ...
                    <div className="mt-auto">
                        ...
                        }} className="text-gray-700 hover:text-cyan-500 cursor-pointer font-medium flex items-center gap-1">
