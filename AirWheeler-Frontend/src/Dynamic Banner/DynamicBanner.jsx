          ...
          (
            <div className='relative overflow-hidden rounded-lg max-sm:h-[200px] max-sm:rounded-none shadow-sm shadow-gray-400 md:-mt-20'>
              ...
              <img data-aos="fade-up"
                data-aos-duration="2000" loading="lazy" src={` ${item?.bannerImgUrl[0] || `https://upload.wikimedia.org/wikipedia/commons/thumb/d/d1/Image_not_available.png/800px-Image_not_available.png?20210219185637`} `} className='h-full w-full' alt="" />
