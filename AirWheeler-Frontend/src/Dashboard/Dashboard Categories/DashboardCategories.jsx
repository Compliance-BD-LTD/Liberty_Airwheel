...
export const DashboardCategories = () => {
    ...
    return (
        <div className='md:mx-4 my-2 space-y-3 w-full px-5 '>
            ...
            <label htmlFor="my_modal_3" className='btn text-base font-semibold hover:bg-cyan-400 bg-cyan-500 rounded-md text-white  '>
                        ...
                        return (
                            <div className='relative group' key={index}>
                                <div onClick={() => handleClick(item)} className="card cursor-pointer relative bg-base-100 p-10 border-2 border-cyan-500 rounded-md overflow-hidden  shadow-sm">
                                    ...
                                    <div >
                                        <p className='absolute bottom-2 left-2 text-center font-semibold text-xl text-gray-500 '>{capitalizeWords(item?.name)}</p>
                                    </div>
