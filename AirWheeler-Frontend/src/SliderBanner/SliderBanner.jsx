                                ...
                                banners.length > 1 ?
                                    banners.map((item, index) => {
                                        ...
                                        return (
                                            <div className="w-full bg-cyan-100 md:h-screen overflow-hidden " key={index}>
                                                <img src={item.imageUrl[0]} className="w-full h-full    " loading="lazy"
                                                    decoding="async" alt="" />
                                            </div>
                                        )
                                    })
                                    ...
                                    [1, 2].map((item, index) => {
                                        return (
                                            <div className="w-full bg-cyan-100 md:h-screen overflow-hidden " key={index}>
                                                <img loading="lazy"
                                                    decoding="async" src={banners[0].imageUrl[0] || `https://elomus-theme.myshopify.com/cdn/shop/files/slider2-elomus1-1920x900.jpg?crop=center&format=pjpg&height=900&v=1613722537&width=1920`} className="w-full h-full    " alt="" />
                                            </div>
                                        )
                                    })
