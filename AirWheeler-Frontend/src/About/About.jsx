...
export const About = () => {
    ...
    return (
        <div className="bg-cyan-400[55px]">
            <div className=" relative w-full  bg-cyan-100 h-[500px]  -mt-[55px] overflow-hidden " >
                ...
                <div className="text-left w-3/4  md:w-[650px] space-y-5 absolute top-2/3 left-1/2 md:left-1/3 transform -translate-x-1/2  -translate-y-1/2">
                    ...
                    <button className="font-semibold text-white hover:bg-cyan-400 transition-all duration-300 cursor-pointer px-10 py-3 rounded-l-full rounded-r-full border-2 border-cyan-500">Get Started</button>
                </div>
            </div>
