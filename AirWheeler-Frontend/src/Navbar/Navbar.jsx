...
export const Navbar = ({ categories, country }) => {
  ...
  let navbarClasses = `
        ...
        ${
          scrolled || isDashboard
            ? "fixed w-full    top-0 z-50 bg-white  text-cyan-500 shadow-lg"
  ...
  return (
    <div className="relative z-10  ">
      <nav
        className={` mx-auto md:h-[50px] max-sm:py-2  px-5 fixed w-full  backdrop-blur-xs  bg-cyan-400/10`}
      >
        <div className="flex justify-between mx-auto items-center max-w-[1340px]">
          ...
          <div className="space-x-5 md:hidden">
            <label
              ...
              className="drawer-button lg:hidden text-cyan-500 text-xl cursor-pointer"
            >
              ☰
            </label>
          </div>
