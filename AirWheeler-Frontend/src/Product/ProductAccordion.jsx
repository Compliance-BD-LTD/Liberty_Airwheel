  ...
  <table className="w-full text-base">
    <tbody>
      {data && data.map((ele, idx) => (
        ...
        >
          <td className="py-4 px-4 font-medium w-1/2">{Object.keys(ele)[0]}</td>
  ...
  return (
    <div className="border border-gray-300 rounded-md max-w-2xl  bg-white">
      ...
      <div className="py-8 flex justify-start px-5">
        <button onClick={handleModal} className="bg-cyan-500 cursor-pointer hover:bg-cyan-600 text-white text-lg font-semibold rounded-full px-10 py-3 flex items-center gap-2 transition">
